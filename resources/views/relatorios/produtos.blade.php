...
@section('breadcrumb')
@breadcrumbs(['title'=>'Relatório: Produtos',
'icon'=>'fa-circle-o','route'=>route('relatorio.produtos'),'subtitle'=>'Relatório de
Produtos'])
@endbreadcrumbs
@endsection
@section('toolbar')
...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            ...
            {!! Form::open(['route'=>'relatorio.produtos','id'=>'form_pesquisa'])!!}
            <div class="row">
                <div class="col-md-3">
